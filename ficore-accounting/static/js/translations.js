(function () {
    ...
    const englishGroceryTranslations = {
        just_now: "Just now",
        minutes_ago: "m ago",
        hours_ago: "h ago",
        days_ago: "d ago",
    ...
    const englishFoodOrderTranslations = {
        just_now: "Just now",
        minutes_ago: "m ago",
        hours_ago: "h ago",
        days_ago: "d ago",
    ...
    window.groceryTranslations = {
        ...
        no_lists: "Babu jerin kayan miya da aka samu",
        ...
        grocery_lists: "Jerin Kayan Miya",
        grocery_meal_plans: "Shirye-shiryen Abinci",
        grocery_suggestions: "Shawarwari",
        grocery_create_list: "Ƙirƙiri Jerin Kayan Miya",
        ...
        grocery_list_created: "An ƙirƙiri jerin kayan miya",
        ...
        friday_reminder: "Jumma'a ce! Lokaci ya yi da za a shirya jerin kayan miya na ƙarshen mako.",
        ...
        grocery_list_deletion_initiated: "An fara gogewar jerin kayan miya",
        grocery_list_deleted: "An goge jerin kayan miya",
        grocery_deleting_in: "Gogewa a cikin",
        grocery_seconds: "sakanni",
        grocery_export_pdf_success: "An fitar da jerin kayan miya zuwa PDF",
        grocery_export_error: "Kuskure wajen fitarwa zuwa PDF",
        grocery_list_error: "Kuskure wajen loda bayanan jerin",
        grocery_list_updated: "An sabunta jerin kayan miya",
        ...
        grocery_modal_label: "Mai Shirya Kayan Miya Mai Wayo",
        ...
        grocery_spending: "Kashe Kayan Miya",
        ...
        javascript_required_grocery: "Ana buƙatar JavaScript don amfani da Mai Shirya Kayan Miya. Da fatan za a kunna shi a cikin burauzarka.",
        ...
        recent_activity_grocery_list_created: "An ƙirƙiri jerin kayan miya: {name}",
    ...
    window.foodOrderTranslations = {
        ...
        general_error: "Kuskure ya faru",
        insufficient_credits: "Rashin isassun ƙididdiga",
        not_found: "Ba a sami umurni ko abu ba",
        ...
        food_order_missing_location: "Ana buƙatar wuri",
    ...
    window.t = function (key, options = {}) {
        const { context = 'grocery', default: defaultValue = key } = options;
        const translations = context === 'foodOrder' ? window.foodOrderTranslations : window.groceryTranslations;
        const englishTranslations = context === 'foodOrder' ? englishFoodOrderTranslations : englishGroceryTranslations;

        // Check browser language or default to Hausa
        const userLanguage = navigator.language.split('-')[0] || 'ha';

        // Return Hausa translation if available and language is set to Hausa
        if (userLanguage === 'ha' && translations[key]) {
            return translations[key];
        }

        // Fallback to English translation
        return englishTranslations[key] || defaultValue;
    };
})();
