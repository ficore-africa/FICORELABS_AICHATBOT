                ...
                <div class="tab-pane fade show active" id="lists" role="tabpanel" aria-labelledby="lists-tab">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-primary" onclick="groceryModule.createGroceryList()">${window.groceryTranslations.grocery_create}</button>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-primary" onclick="groceryModule.addGroceryItem()">${window.groceryTranslations.grocery_add}</button>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-primary" onclick="groceryModule.shareGroceryList()">${window.groceryTranslations.grocery_share}</button>
                        </div>
                    </div>
                </div>
